...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Authentication Bypass</h1>
                    <div class="card-header">SQL Injection</div>
 
                    <div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">                   <div class="card-body">
...
<center><h1>Weak Login Credentials</h1>
<h3>As the name suggests, Weak Login Credentials are those credentials which are default and never changed like "admin-password" .</h3></center>
  <br><br>
<center>
