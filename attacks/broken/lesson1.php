...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Broken Authentication and Session Management</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">Weak Login Credentials</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">As the name suggests, Weak Login Credentials are those credentials which are default and never changed like "admin-password" .</p>
  </div>
</div>
<br>
<br>
