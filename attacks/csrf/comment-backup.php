...
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">CSRF in Comment Box</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">When you'll enter by this login form, you'll get a page with a Comment Box and with some type Ad which will redirect you to a type of unauthorized link.</p>
  </div>
</div>
<br>
<br>
