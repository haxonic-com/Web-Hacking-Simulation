...
<nav class="sb-topnav navbar navbar-expand-sm bg-dark navbar-dark"><a href="./index.php">
            </a><a class="navbar-brand" href="index.php"><font size="7" face="Revamped" color="white">WAVS</font></a>
            <button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#">
                <svg class="svg-inline--fa fa-bars fa-w-14" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="bars" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">CSRF in Comment</li>
                        </ol>
                    </div>
                    <div>
...
<div>
<a href="logout1.php" style="align:left;"><h3>Logout</h3><br></a>
<div id="fr" style="align:left;">
<a target="_blank" href="y.php">
<br><img src="ad.jpg" height="230" width="350" id="ad"></img><br>
</a></div>
<center>
 <h3 style="margin-left:30%;">Enter your comment</h3> 

<form action=fb.php method="GET" align="center" style="margin-left:30%">
...
echo "<html><body><div><center><u><b><br>All Comments from Admin</b></u><br></center></div></body></html>";
...
{
$msg=$row['Message'];
echo "<html><body><div><center>&nbsp;$msg<br><br></center></div></body></html>";
}
}
?>    
</center>
