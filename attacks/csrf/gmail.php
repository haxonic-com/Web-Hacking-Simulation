...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Cross-Site Request Forgery (CSRF)</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">CSRF in GMAIL (Logout)</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">When you click on the below query link, you'll be logged out to all the Single Sign In Accounts of Gmail.</p>
  </div>
</div>
<br>
<br>
...
<a class="btn btn-success" href="https://accounts.youtube.com/accounts/Logout2?hl=en&service=mail&ilo=1&ils=s.youtube,s.IN&ilc=0&continue=https://accounts.google.com/ServiceLogin?service=mail&passive=true&rm=false&continue=https://mail.google.com/mail/&ss=1&scc=1&ltmpl=default&ltmplcache=2&hl=en&emr=1&zx=851789340" target="_blank">Click Here</a>
