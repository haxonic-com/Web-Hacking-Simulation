...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Unrestricted File Upload</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">Arbitrary File Upload</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">You can Upload any Arbitrary File here such as "b374k" to access the Command Prompt of the Server in which you can execute any query you want.</p>
  </div>
</div>
<br>
<br>
