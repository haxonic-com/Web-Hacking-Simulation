...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Attack Name</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">SQL Injection</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">SQL injection usually occurs when you ask a user for input, like their username/userid, and instead of a name/id, the user gives you an SQL statement that you will unknowingly run on your database.
 
 You have to put some kind of combination of SQL Syntax Parameters here of " ' " to bypass the Authentication.</p>
  </div>
</div>
<br>
<br>
...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
 ...
 <h4>SQL injection usually occurs when you ask a user for input, like their username/userid, and instead of a name/id, the user gives you an SQL statement that you will unknowingly run on your database.  </h4>
 <br>
 <h4>You have to put some kind of combination of SQL Syntax Parameters here of " ' " to bypass the Authentication.</h4></center><br><br><br>
   <center>
    <h3>Enter to your Account</h3><br>
    <div>
  <form action="auth.php" method="POST">
