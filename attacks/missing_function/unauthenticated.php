...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Missing Function Level Access Control</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">Unauthenticated User Access to Admin</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">Bypass Authentication by replacing /unauthenticated.php with /admin.php in URL. </p>
  </div>
</div>
<br>
<br>
