                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <li class="breadcrumb-item active"><a href="../../index.php">Home</a></li>
                            <li class="breadcrumb-item active"><a href="../../attacks/security_misconfiguration/sec.php">Security Misconfiguration</a></li>
                            <li class="breadcrumb-item active"><a href="../../attacks/security_misconfiguration/bruteforce.php">Vulnerable Machine</a></li>
                        </ol>
                    </div>
                    <div>
                    <center><h1>Security Misconfiguration</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">Brute Force Attack</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">Brute Force Attack is the simplest method to gain access to a site or server. It tries various combinations of usernames and passwords again and again until it gets in.<br> The Username is "admin" , "admin2" , "root" etc. You just have to brute force the password in this.</p>
  </div>
</div>
<br>
<br>
