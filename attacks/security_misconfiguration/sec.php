                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapse4" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="#">About</a><a class="nav-link" href="../../attacks/security_misconfiguration/bruteforce.php">Brute Force Attack</a></nav>
                            </div>
...
<span id="c"><b>What is Security Misconfiguration?</b></span>
...
<p>Security Misconfiguration as its name suggests is a vulnerability that might occur in a web application or the web server 
 ...
 <span id="c"><b>Are You Vulnerable To 'Security Misconfiguration'?</b></span>
...
Without a concerted, repeatable application security configuration process, systems are at a higher risk.</li></p>
</ul>
...
Automated scanners are useful for detecting missing patches, misconfigurations, use of default accounts, unnecessary services, etc.</p>
