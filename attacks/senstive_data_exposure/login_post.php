...
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">User Credentials Sent in Plaintext</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">The Credentials are sent in Plaintext to the Database without using any Encryption Format. Check the URL after Login.</p>
  </div>
</div>
<br>
<br>
