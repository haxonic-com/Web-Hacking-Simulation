...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Sensitive Data Exposure</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">Plaintext Passwords from Database</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">Enter ?Id=1 / ?Id=2 etc. in URL<br>By entering ?Id=1 / ?Id=2 you will get Credentials from <br>the Database with the help of Union Based Sql <br>Injection in which you'll get 'GET' parameters.</p>
  </div>
</div>
<br>
<br>
...
if($query_run=mysqli_query($link, $query1))
{
  ...
  #<a href="../../index.php"><h2>Web Application Based Vulnerabilities Simulator</h2></a></center>';
    }
}
}
else
