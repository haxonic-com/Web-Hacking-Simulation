                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active"><a href="../../attacks/senstive_data_exposure/plaintext.php">Vulnerable Machine</a></li>
...
<div align="right"><a href="logout1.php"><font color="red">Logout</font></a></div>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
 
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text"><code>[Look at the URL]</code> <br>Congrats!<br>You Cracked it!!!</p>
  </div>
</div>
</center>
                </main>
