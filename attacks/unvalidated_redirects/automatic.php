...
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">Automatic Redirects</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">
In Automatic Redirects, You are going through a Untrusted Website in which if you click on an image or just visit a page, you automaically redirected to a Bad Malicious Website or Website having Bad Content in just a blink of your eye.</p>
  </div>
</div>
<br>
<br>
...
{//document.write("You will be redirected to main page in 5 sec.");
   ...
   setTimeout('window.location="welcome.html";', 5000); 
