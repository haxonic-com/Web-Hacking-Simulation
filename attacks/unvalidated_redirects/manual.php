...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div>
                    <center><h1>Unvalidated Redirects & Forwards</h1>
<div class="card text-dark bg-white mb-3 z-depth-2" style="max-width: 50rem;">
  <div class="card-header">Manual Redirects</div>
  <div class="card-body">
    <!-- <h5 class="card-title">Hint</h5> -->
    <p class="card-text">In Manual Redirects, You Login to a Untrusted Website with your any Social Media Credentials and you redirected to a bad malicious site or the site having bad content. There can be a change in redirectTo value in url OR in a Button, you should examine it and then login into a particular website.</p>
  </div>
</div>
<br>
<br>
<!-- <div class="z-depth-5" style="max-width: 50rem;">
   ...
   <center>     <form action="virus.php" method="GET">
